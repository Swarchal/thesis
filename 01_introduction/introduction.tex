...
% TODO: conclude this subsection, summarise in context of the CCM study
...
%The choice of the distance or similarity metric is largely dependent on the dimensionality of the data and the intended downstream applications, although the distinction between distance and similarity is not important, as many similarity metrics and be converted to distances as $1 - \text{similarity}$.
...
% TODO: either remove or extend this paragraph. At the moment it starts and
% finishes halfway through

%One of the most commonly used metrics in multivariate analysis is computing distances between objects in high-dimensional space, in the case of high-content screening these objects are usually cellular phenotypes induced by small molecules.
%There are a number
...
% TODO: Patients diagnosed as ER positive or HER2 positive...
